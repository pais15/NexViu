...
@app.on_message(filters.text == "👥 لیست کاربران")
async def list_users(client, m: Message):
    pass


@app.on_message(filters.text == "🛑 حذف کاربران متخلف")
async def delete_offending_users(client, m: Message):
    pass


@app.on_message(filters.text == "📊 گزارش و آمار سیستم")
async def system_reports_stats(client, m: Message):
    pass


@app.on_message(filters.text == "💰 تنظیم هزینه تبلیغات")
async def set_advertisement_cost(client, m: Message):
    pass


@app.on_message(filters.text == "💵 تنظیم درآمد منتشرکنندگان")
async def set_publisher_income(client, m: Message):
    pass


@app.on_message(filters.text == "💳 شارژ حساب / امور مالی")
